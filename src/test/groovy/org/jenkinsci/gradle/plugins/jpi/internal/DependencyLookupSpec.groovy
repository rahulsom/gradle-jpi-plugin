...
class DependencyLookupSpec extends Specification {
    ...
    def 'should get testImplementation dependencies for #version'(String version, Set<String> expected) {
        ...
        '2.64'  | ['org.jenkins-ci.main:jenkins-core:2.64', 'org.jenkins-ci.main:jenkins-test-harness:1529.v4fd5bafdcd33', 'org.jenkins-ci.main:ui-samples-plugin:2.0'] as Set
    }
    ...
    def 'should get generatedJenkinsTestImplementation dependencies for version'() {
        ...
        actual == [
                ...
                'org.jenkins-ci.main:jenkins-test-harness:1529.v4fd5bafdcd33',
        ] as Set<String>
    }
}
